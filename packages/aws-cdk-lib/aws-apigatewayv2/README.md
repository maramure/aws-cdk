...
```ts
const apiKey = new apigatewayv2.ApiKey(this, "ApiKey");

const usagePlan = new apigatewayv2.UsagePlan(this, "UsagePlan", {
...
```ts
const api = new apigatewayv2.WebSocketApi(this, 'my-api');
const stage = new apigatewayv2.WebSocketStage(this, 'my-stage', {
  webSocketApi: api,
  stageName: 'dev',
});

const usagePlan = new apigatewayv2.UsagePlan(this, 'my-usage-plan', {
  usagePlanName: 'Basic',
});
...
```ts
const usagePlan: IUsagePlan = apigatewayv2.UsagePlan.fromUsagePlanId(this, 'imported-usage-plan', '<usage-plan-id>');
```
...
const autoKey = new apigatewayv2.ApiKey(this, 'AutoKey');                                                                                                            
                                                                                                                                                                     
// Explicit name and value                                                                                                                                           
const explicitKey = new apigatewayv2.ApiKey(this, 'ExplicitKey', {                                                                                                   
...
```ts
const importedKey = apigatewayv2.ApiKey.fromApiKeyId(this, 'imported-key', '<api-key-id>');
```
...
```ts
declare const webSocketApi: apigatewayv2.IWebSocketApi;
                                                                                                                                                                                   
const importedStage = apigatewayv2.WebSocketStage.fromWebSocketStageAttributes(this, 'imported-stage', {                                                                           
  stageName: 'myStage',                                                                                                                                                            
  api: webSocketApi,                                                                                                                                                               
});                                                                                                                                                                                
                                                                                                                                                                                   
const apiKey = new apigatewayv2.ApiKey(this, 'MyApiKey');                                                                                                                          
                                                                                                                                                                                   
const usagePlan = new apigatewayv2.UsagePlan(this, 'MyUsagePlan', {                                                                                                                
...
```ts
declare const usagePlan: apigatewayv2.UsagePlan;
declare const apiKey: apigatewayv2.ApiKey;
...
```ts
declare const api: apigatewayv2.WebSocketApi;
declare const stage: apigatewayv2.WebSocketStage;

const key = new apigatewayv2.RateLimitedApiKey(this, 'rate-limited-api-key', {
  customerId: 'test-customer',
  apiStages: [{
    api: api,
    stage: stage
  ...
  quota: {
    limit: 10000,
    period: apigatewayv2.Period.MONTH
  },
  throttle: {
    rateLimit: 100,
    burstLimit: 200
